...
import frc.team670.robot.commands.drivebase.MoveToPoseVision;
import frc.team670.robot.constants.FieldConstants;
import frc.team670.robot.constants.RobotConstants.Vision;
 ...
 * the closest one.`
 */
public class AutoAlignVision extends CommandBase implements MustangCommand {
    private DriveBase driveBase;
    private MoveToPoseVision moveCommand;
    private int goal;
    ...
    public AutoAlignVision(DriveBase driveBase, Direction direction) {
        this.driveBase = driveBase;
        // this.controller = controller;
        this.direction = direction;
        vision = driveBase.getPoseEstimator().getVision();
    }
    ...
    public void initialize() {
        ...
        //         estimatedPose = estimation.estimatedPose.toPose2d();
        //     }
        // }
        if(estimatedPose == null)
            estimatedPose = driveBase.getPose();
            
        goal = getClosestTargetIndex(estimatedPose);
        ...
        this.moveCommand = new MoveToPoseVision(driveBase, goalPose);
