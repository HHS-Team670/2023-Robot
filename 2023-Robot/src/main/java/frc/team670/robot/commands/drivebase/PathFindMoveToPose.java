...
public class PathFindMoveToPose extends CommandBase implements MustangCommand {
    ...
    public PathFindMoveToPose(SwerveDrive driveSystem, PathConstraints constraints,
            Node finalPosition, List<Obstacle> obstacles, VisGraph AStarMap) {
        this.driveSystem = driveSystem;
        this.constraints = constraints;
        this.obstacles = obstacles;
        this.finalPosition = finalPosition;
        this.AStarMap = AStarMap;
        this.startPoint = new Node(driveSystem);
