 ...
 */
public class MoveToPoseVision extends CommandBase implements MustangCommand {
    ...
    public MoveToPoseVision(DriveBase driveBase, Pose2d endPose) {
    ...
    public void initialize() {
        ...
        //         startPose = estimation.estimatedPose.toPose2d();
        //     }
        // }
        if(startPose == null)
            startPose = driveBase.getPose();
