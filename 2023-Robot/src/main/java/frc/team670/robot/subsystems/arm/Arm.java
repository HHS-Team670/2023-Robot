...
public class Arm extends MustangSubsystemBase {
    ...
    private static final ArmState[][] VALID_PATHS_GRAPH = new ArmState[][] {
            ...
            { ArmState.STOWED, ArmState.SCORE_MID, ArmState.SCORE_HIGH, ArmState.INTAKE_SHELF,
                    ArmState.UPRIGHT_GROUND }, // HYBRID
            { ArmState.SCORE_HIGH, ArmState.STOWED, ArmState.STARTING, ArmState.HYBRID, ArmState.SINGLE_STATION,
                    ArmState.UPRIGHT_GROUND }, // SCORE_MID
            { ArmState.SCORE_MID, ArmState.STOWED, ArmState.HYBRID, ArmState.SINGLE_STATION, ArmState.INTAKE_SHELF,
                    ArmState.STARTING, ArmState.UPRIGHT_GROUND }, // SCORE_HIGH
