...
public class Arm extends MustangSubsystemBase {
    ...
    private static final ArmState[][] VALID_PATHS_GRAPH = new ArmState[][] {
            { ArmState.TUNING, ArmState.SCORE_MID, ArmState.SINGLE_STATION, ArmState.SCORE_HIGH, ArmState.HYBRID, ArmState.INTAKE_SHELF, ArmState.UPRIGHT_GROUND, ArmState.STATION_KICK, ArmState.INTERMEDIATE_BACKWARD_GROUND }, // STOWED
            ...
            { ArmState.STOWED },
            { ArmState.STOWED, ArmState.BACKWARD_GROUND},
            { ArmState.INTERMEDIATE_BACKWARD_GROUND},
    ...
    private static final Map<ArmState, Map<ArmState, double[]>> timeDelays = Map.ofEntries(
        ...
        // may add backwards states delays if needed
    );
