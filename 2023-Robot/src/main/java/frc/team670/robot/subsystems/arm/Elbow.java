...
public class Elbow extends SparkMaxRotatingSubsystem {
    ...
    private void setEncoderPositionFromAbsolute() {
        ...
        if (absEncoderPosition != 0.0) {
            ...
            if (calculatedRelativePosition == 0.0
                    || Math.abs(360 * ((previousPositionRot - relativePosition) / this.ROTATOR_GEAR_RATIO)) < 10.0) {
                clearSetpoint();
    ...
    public void debugSubsystem() {
        ...
        SmartDashboard.putNumber("Elbow previous reading", previousReading);
        ...
        SmartDashboard.putNumber("Elbow motor power: ", super.rotator.get());
    }
