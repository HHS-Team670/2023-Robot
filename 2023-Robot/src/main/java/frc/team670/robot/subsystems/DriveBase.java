...
public class DriveBase extends SwerveDrive {
      ...
      public DriveBase(MustangController mustangController) {
            super(new SwerveConfig(RobotConstants.DRIVETRAIN_TRACKWIDTH_METERS,
                        RobotConstants.DRIVETRAIN_WHEELBASE_METERS,
                        MAX_VELOCITY_METERS_PER_SECOND, MAX_VOLTAGE, RobotConstants.NAVX_PORT,
                        RobotConstants.FRONT_LEFT_MODULE_DRIVE_MOTOR, RobotConstants.FRONT_LEFT_MODULE_STEER_MOTOR,
                        RobotConstants.FRONT_LEFT_MODULE_STEER_ENCODER, RobotConstants.FRONT_LEFT_MODULE_STEER_OFFSET,
                        RobotConstants.FRONT_RIGHT_MODULE_DRIVE_MOTOR, RobotConstants.FRONT_RIGHT_MODULE_STEER_MOTOR,
                        RobotConstants.FRONT_RIGHT_MODULE_STEER_ENCODER, RobotConstants.FRONT_RIGHT_MODULE_STEER_OFFSET,
                        RobotConstants.BACK_LEFT_MODULE_DRIVE_MOTOR, RobotConstants.BACK_LEFT_MODULE_STEER_MOTOR,
                        RobotConstants.BACK_LEFT_MODULE_STEER_ENCODER, RobotConstants.BACK_LEFT_MODULE_STEER_OFFSET,
                        RobotConstants.BACK_RIGHT_MODULE_DRIVE_MOTOR, RobotConstants.BACK_RIGHT_MODULE_STEER_MOTOR,
                        RobotConstants.BACK_RIGHT_MODULE_STEER_ENCODER, RobotConstants.BACK_RIGHT_MODULE_STEER_OFFSET));
