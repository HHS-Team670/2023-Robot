...
import frc.team670.mustanglib.subsystems.drivebase.SwerveDriveIOInputsAutoLogged;
...
public class DriveBase extends SwerveDrive {
    ...
    public DriveBase() {
        super(new DriveBaseIO(RobotConstants.DriveBase.kConfig), new SwerveDriveIOInputsAutoLogged());
    }
    ...
    protected void initPoseEstimator() {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'initPoseEstimator'");
    }

    public static class DriveBaseIO extends SwerveDriveIO{

        
        public DriveBaseIO(Config config) {
            super(config);
        }
