...
public final class RobotConstants extends RobotConstantsBase {
         ...
         * wheels so they are
         * facing in the forwards direction. NOTE: The wheels will be pointed forwards
         * (not backwards)
         * when modules are turned so the large bevel gears are towards the LEFT side of
         * the robot. When
         * aligning the wheels they must be as straight as possible. It is recommended
         * to use a long
         * strait edge such as a piece of 2x1 in order to make the wheels straight. 4)
         * Record the angles
         * of each module using the angle put onto Shuffleboard. The values are named
         * Front Left Module
         ...
         * not, add 180 degrees to the offset of each wheel that is spinning in the
         * incorrect direction.
        ...
        public static Map<String, Map<String, Double>> hardwareSpecificConstants = Map.ofEntries(
                        ...
                        entry("00:80:2F:33:D0:46", Map.ofEntries( // The mac address is from 670_2023
                                        ...
                                        entry("SWERVE_MODULE_CONFIGURATION", 1.0),
                                        entry("WRIST_GEAR_RATIO", 125.0))),
        ...
        public static final int SHOULDER_GEAR_RATIO = (hardwareSpecificConstants.get(MAC_ADDRESS)
                        .get("SHOULDER_GEAR_RATIO")).intValue();
        ...
        // Wrist
        public static final double WRIST_ABSOLUTE_ENCODER_AT_VERTICAL = hardwareSpecificConstants.get(MAC_ADDRESS)
                        .get("WRIST_ABSOLUTE_ENCODER_AT_VERTICAL");
        public static final double WRIST_GEAR_RATIO = (hardwareSpecificConstants.get(MAC_ADDRESS)
                        .get("WRIST_GEAR_RATIO")).intValue();;
