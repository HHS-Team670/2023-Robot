...
public class FieldConstants {
    ...
    public static final List<Obstacle> obstacles = List.of(
            ...
            new Obstacle(
                    new double[] {FieldConstants.Community.chargingStationCorners[0].getX(),
                    ...
                    new double[] {FieldConstants.Community.chargingStationCorners[0].getY(),
    ...
    public static List<PoseNode> obstacleContingencyPoints = List.of(
        new PoseNode(fieldWidth, fieldLength)
