...
public class FieldConstants {
    ...
    public static final class LoadingZone {
        ...
        public static final Pose2d[] IntakePoses = {
                new Pose2d(fieldLength - 0.31 - RobotConstants.DRIVEBASE_CLEARANCE, 6.01, new Rotation2d()),
                new Pose2d(fieldLength - 0.31 - RobotConstants.DRIVEBASE_CLEARANCE, 6.01 + 1.31,
                        new Rotation2d()),
                new Pose2d(singleSubstationTranslation.minus(new Translation2d(0, RobotConstants.DRIVEBASE_CLEARANCE)),
    ...
    public static final List<Obstacle> obstacles = List.of(
            ...
            new Obstacle(new Translation2d[] { allianceFlip(obstacleCorners[0]), allianceFlip(obstacleCorners[1]),
    ...
    public static List<PoseNode> obstacleContingencyNodes = List.of(
            new PoseNode(
                    allianceFlip(Community.chargingStationCorners[0].plus(new Translation2d(
                            -RobotConstants.DRIVEBASE_CLEARANCE, -RobotConstants.DRIVEBASE_CLEARANCE))),
                    new Rotation2d()),
            new PoseNode(
            ...
            new PoseNode(
                    allianceFlip(Community.chargingStationCorners[3].plus(
                            new Translation2d(RobotConstants.DRIVEBASE_CLEARANCE, RobotConstants.DRIVEBASE_CLEARANCE))),
                    new Rotation2d()),
            new PoseNode(
