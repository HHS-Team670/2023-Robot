...
public class FieldConstants {
        ...
        public static final class Community {
                ...
                public static final double midX = Units.inchesToMeters(132.375); // Tape to the left
                                                                                 // of charging
                                                                                 // station
                public static final double outerX = Units.inchesToMeters(193.25); // Tape to the
                                                                                  // right of
                                                                                  // charging
                                                                                  // station
        ...
        public static final class Grids {
                ...
                static {
                        for (int i = 0; i < nodeRowCount; i++) {
                                ...
                                lowTranslations[i] = new Translation2d(lowX,
                                                nodeFirstY + nodeSeparationY * i);
                                midTranslations[i] = new Translation2d(midX,
                                                nodeFirstY + nodeSeparationY * i);
                                mid3dTranslations[i] = new Translation3d(midX,
                                                nodeFirstY + nodeSeparationY * i,
                                                isCube ? midCubeZ : midConeZ);
                                high3dTranslations[i] = new Translation3d(highX,
                                                nodeFirstY + nodeSeparationY * i,
                                                isCube ? highCubeZ : highConeZ);
                                highTranslations[i] = new Translation2d(highX,
                                                nodeFirstY + nodeSeparationY * i);
                        }
                }
                ...
                public static final Translation2d[] complexLowTranslations = new Translation2d[] {
                                new Translation2d(complexLowXCones,
                                                nodeFirstY - complexLowOuterYOffset),
                ...
                static {
                        for (int i = 0; i < scoringPoses.length; i++) {
                                scoringPoses[i] = allianceFlip(new Pose2d(
        ...
        public static final class LoadingZone {
                ...
                public static final Translation2d[] regionCorners = new Translation2d[] {
                                new Translation2d(midX, rightY), // Start at lower left next to
                ...
                public static final Pose2d[] loadingZoneIntakeTranslations =
                                {new Pose2d(fieldLength - 0.31, 6.01, new Rotation2d()),
                                                new Pose2d(fieldLength - 0.31, 6.01 + 1.31,
                                                                new Rotation2d()),
        ...
        public static final class StagingLocations {
                ...
                static {
                        for (int i = 0; i < translations.length; i++) {
                                translations[i] = new Translation2d(positionX,
                                                firstY + (i * separationY));
                        }
                }
        }
        ...
        public static final Translation2d[] obstacleCorners = {
                        // right inner
                        allianceFlip(new Translation2d(
        ...
        public static List<PoseNode> obstacleContingencyNodes = List.of(
                new PoseNode(allianceFlip(Community.chargingStationCorners[0].plus(new Translation2d(-RobotConstants.DRIVEBASE_CLEARANCE, -RobotConstants.DRIVEBASE_CLEARANCE))), new Rotation2d()),
                new PoseNode(allianceFlip(Community.chargingStationCorners[1].plus(new Translation2d(-RobotConstants.DRIVEBASE_CLEARANCE, RobotConstants.DRIVEBASE_CLEARANCE))), new Rotation2d()),
                new PoseNode(allianceFlip(Community.chargingStationCorners[3].plus(new Translation2d(RobotConstants.DRIVEBASE_CLEARANCE, RobotConstants.DRIVEBASE_CLEARANCE))), new Rotation2d()),
                new PoseNode(allianceFlip(Community.chargingStationCorners[2].plus(new Translation2d(RobotConstants.DRIVEBASE_CLEARANCE, -RobotConstants.DRIVEBASE_CLEARANCE))), new Rotation2d())
        );
         ...
         * default, all translations and poses in {@link FieldConstants} are stored with the origin
