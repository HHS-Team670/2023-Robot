...
public class FieldConstants {
        ...
        public static final List<Obstacle> obstacles = List.of(
                        ...
                        new Obstacle(new double[] {
                                        ...
                                        new double[] {FieldConstants.Community.chargingStationCorners[0]
                                                        .getY(),
                        ...
                        new Obstacle(new double[] {allianceFlip(
                                        FieldConstants.Community.chargingStationCorners[2]).getX(),
                                        allianceFlip(FieldConstants.Community.chargingStationCorners[3])
                                                        .getX(),
                                        allianceFlip(FieldConstants.Community.chargingStationCorners[1])
                                                        .getX(),
                                        allianceFlip(FieldConstants.Community.chargingStationCorners[0])
                                                        .getX(),},
                                        new double[] {allianceFlip(
                                                        FieldConstants.Community.chargingStationCorners[2])
                                                                        .getY(),
                                                        allianceFlip(FieldConstants.Community.chargingStationCorners[3])
                                                                        .getY(),
        ...
        static {
                double driveBaseClearance = Math.hypot(RobotConstants.DRIVEBASE_WIDTH,
                                RobotConstants.DRIVEBASE_WIDTH) / 2 + 0.1;
                for (Obstacle o : obstacles) {
                        // clockwise from inner right
                        obstacleContingencyNodes.add(new PoseNode(
                                        o.getCorners()[0].getX() + driveBaseClearance,
                                        o.getCorners()[0].getY() + driveBaseClearance));
                        obstacleContingencyNodes.add(new PoseNode(
                                        o.getCorners()[1].getX() + driveBaseClearance,
                                        o.getCorners()[1].getY() + driveBaseClearance));
                        obstacleContingencyNodes.add(new PoseNode(
                                        o.getCorners()[2].getX() + driveBaseClearance,
                                        o.getCorners()[2].getY() + driveBaseClearance));
                        obstacleContingencyNodes.add(new PoseNode(
                                        o.getCorners()[3].getX() + driveBaseClearance,
                                        o.getCorners()[3].getY() + driveBaseClearance));
                }
        }
