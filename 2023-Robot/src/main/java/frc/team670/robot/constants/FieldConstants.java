...
public class FieldConstants {
    ...
    public static final List<Obstacle> obstacles = List.of(
            ...
            new Obstacle(new Translation2d[] {allianceFlip(obstacleCorners[0]),
                    allianceFlip(obstacleCorners[1]), allianceFlip(obstacleCorners[2]),
                    allianceFlip(obstacleCorners[3])}));

    // public static double driveBaseClearance =
    // Math.hypot(RobotConstants.DRIVEBASE_WIDTH, RobotConstants.DRIVEBASE_WIDTH) / 2 + 0.1;
    public static double driveBaseClearance =
