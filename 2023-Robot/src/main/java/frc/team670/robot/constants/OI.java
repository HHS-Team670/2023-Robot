...
public class OI extends OIBase {
    ...
    // JoystickButton(driverController, XboxButtons.RIGHT_BUMPER);
    ...
    private static JoystickButton manualWristControlRight = new JoystickButton(operatorController,
            XboxButtons.RIGHT_JOYSTICK_BUTTON);
    private static JoystickButton manualWristControlLeft = new JoystickButton(operatorController,
    ...
    public void configureButtonBindings(MustangSubsystemBase... subsystemBases) {
        ...
        singleSubAlign.whileTrue(new MoveToPose(driveBase, (FieldConstants.LoadingZone.IntakePoses[0]))); // moves to
                                                                                                          // substation
