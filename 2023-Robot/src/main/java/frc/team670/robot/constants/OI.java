...
public class OI extends OIBase {
        ...
        private static JoystickButton manualElbowControlPositive = new JoystickButton(operatorController,
                        XboxButtons.RIGHT_JOYSTICK_BUTTON);
        private static JoystickButton manualElbowControlNegative = new JoystickButton(operatorController,
